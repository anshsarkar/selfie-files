...
def align_worker(cls):
    global nrof_images_total
    global nrof_successfully_aligned
    global text_file
...
print(type(dataset))    
total_images = print(len(dataset))
...
with open(bounding_boxes_filename, "w") as text_file:
    ...
    with ThreadPoolExecutor(max_workers=40) as executor:
        for _ in tqdm(executor.map(align_worker, dataset), total=total_images):
            pass
